    ...
    <Section id="testimonials" background="navy" padding="xl">
      <div className="text-center mb-10">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <AnimatedHeading as="h2" className="text-4xl md:text-5xl mb-3 text-white">
      ...
      <div className="flex justify-center mb-8">
        <motion.div
          ...
          className="bg-white rounded-xl shadow-2xl px-8 py-8 max-w-2xl w-full text-center mx-2"
        >
          ...
          <div className="flex items-center justify-center gap-3 mt-2">
            ...
            <div className="text-left">
              <div className="font-bold text-navy-900 text-sm">{testimonials[currentIndex].client}</div>
          ...
          {testimonials.slice(startIdx, endIdx).map((testimonial, idx) => {
            ...
            return (
              <button
                ...
                className={`bg-white rounded-xl shadow-lg px-5 py-4 min-w-[220px] max-w-xs text-left transition-all duration-300 border-2 ${
                  realIdx === currentIndex ? 'border-gold-500' : 'border-transparent hover:border-gold-500'
                }`}
              ...
              >
                ...
                <div className="flex items-center gap-2 mt-2">
                  ...
                  <div>
                    <div className="font-bold text-navy-900 text-xs">{testimonial.client}</div>
        ...
        {testimonials.map((_, idx) => (
          <button
            ...
            className={`w-2.5 h-2.5 rounded-full transition-colors duration-200 ${
              idx === currentIndex ? 'bg-gold-500' : 'bg-white/30'
            }`}
